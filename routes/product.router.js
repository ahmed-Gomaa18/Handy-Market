...
router.post('/', auth(productEndPoint.product), upload.array('photos' , 4), HMR, productController.addProduct); // Not we Send Form Data To send whole product at one time  //validateDto(ajvInstance.compile(productSchema.createProduct)), 
